//When a dataset is attached to a item revision with some specific relation then dataset name pattern should be in the form of  “ itemid - revid - n...only one customization
#include <iostream>
...
int datasetcounter = 0; // Initialize to 1
